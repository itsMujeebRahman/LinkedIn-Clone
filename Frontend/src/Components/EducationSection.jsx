            ...
            {isEditing && (
                <div className="mt-4">
                    <input
                        ...
                        className="w-full p-2 border rounded mb-2 edit"
                    />
                    ...
                    <button
                        ...
                        className="Agree text-white py-2 px-2 rounded linkedBtn transition duration-300"
                    >
                        Add Education
                    </button>
                </div>
                ...
                <>
                    {isEditing ? (
                        ...
                        <button
                            ...
                            className="mt-4 linkedBtn2 transition duration-300"
                        >
                            Edit Education
                        </button>
                    )}
