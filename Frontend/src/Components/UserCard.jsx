    ...
    return(
        <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center transition-all hover:shadow-md">
            <Link to={`/profile/${user.username}`} className="flex flex-col items-center">
                ...
                />
                <h3 className="font-semibold text-lg text-center text-darkgray">{user.name}</h3>
            </Link>
            ...
            <button className="mt-4 linkedBtn text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors w-full">
